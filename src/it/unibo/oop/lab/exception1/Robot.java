...
public class Robot {
     ...
     * @throws NotEnoughBatteryException 
     */
    private boolean moveToPosition(final int newX, final int newY) throws PositionOutOfBoundException, NotEnoughBatteryException {
        ...
        if (this.isBatteryEnoughToMove()) {
            ...
            throw new NotEnoughBatteryException(Robot.MOVEMENT_DELTA_CONSUMPTION - this.batteryLevel);
        }
        return returnValue;
    }
